      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20 py-16">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
          ...
          <div className="flex items-center gap-5">
            <a href="https://www.instagram.com/hellospacelift" target="_blank" rel="noopener noreferrer" className="text-[#8D9EB2] hover:text-white transition-colors duration-200" aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@hellospacelift" target="_blank" rel="noopener noreferrer" className="text-[#8D9EB2] hover:text-white transition-colors duration-200" aria-label="YouTube">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/>
                <polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02"/>
              </svg>
            </a>
            <a href="https://www.facebook.com/hellospacelift" target="_blank" rel="noopener noreferrer" className="text-[#8D9EB2] hover:text-white transition-colors duration-200" aria-label="Facebook">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
              </svg>
            </a>
            <a href="https://www.linkedin.com/company/hellospacelift/" target="_blank" rel="noopener noreferrer" className="text-[#8D9EB2] hover:text-white transition-colors duration-200" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round">
