...
// ── Project data ────────────────────────────────────────────────────────────
// Source: apps/hellospacelift/src/data/projects.json
// Fields used: after_image → photo, room_type → roomType, location_display → location
const allProjects = projectsData.filter((p) => p.active)

// ── Filter groups ───────────────────────────────────────────────────────────
// Maps UI filter label -> raw room_type values it should match
          ...
          {/* Projects grid */}
              <section className="bg-white py-16 md:py-24">
                      ...
                      <div className="text-center py-20">
                                    <p className="text-[#8D9EB2] text-lg">No projects found for this category yet.</p>p>
                      </div>div>
                                )}
                      </div>div>
              </section>section>
