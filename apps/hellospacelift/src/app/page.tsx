          ...
          <div className="max-w-[1280px] w-full mx-auto px-6 md:px-12 lg:px-20 pt-32 pb-24 md:pt-40 md:pb-32">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/get-started"
                  onClick={() => track('CTA Clicked', { cta_text: 'Get Started', location: 'homepage_hero', destination: '/get-started' })}
                  className="inline-flex items-center justify-center gap-2 bg-[#141B24] text-white font-semibold px-8 py-4 rounded-full hover:bg-[#1e2a38] transition-colors duration-200 text-base border border-white"
                >
                  Get Started <ArrowRight size={18} strokeWidth={1.25} />
                </Link>
                <Link
                  href="/homeowners"
                  onClick={() => track('CTA Clicked', { cta_text: 'How It Works', location: 'homepage_hero', destination: '/homeowners' })}
      ...
      <section className="bg-[#141B24] py-24 md:py-32">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-3xl">
            ...
            <Link
              href="/get-started"
              onClick={() => track('CTA Clicked', { cta_text: 'Start your renovation', location: 'homepage_brand_promise', destination: '/get-started' })}
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            ...
            <Link
              href="/projects"
              onClick={() => track('CTA Clicked', { cta_text: 'View all projects', location: 'homepage_projects', destination: '/projects' })}
