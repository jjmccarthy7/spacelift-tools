          ...
          <div className="pt-16">
                        ...
                        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20 py-24 md:py-32">
                                  <div className="max-w-3xl">
                                              ...
                                              <div className="flex flex-col sm:flex-row gap-4">
                                                            ...
                                                            <Link
                                                                              href="/homeowners"
                                                                              className="inline-flex items-center justify-center gap-2 border border-[#141B24] text-[#141B24] font-semibold px-8 py-4 rounded-full hover:bg-[#141B24] hover:text-white transition-colors duration-200 text-base"
                                                                            >
                                                                            How it works
                                                            </Link>Link>
                                              </div>div>
            ...
            {/* ── BRAND PROMISE ── */}
                <section className="bg-[#141B24] py-24 md:py-32">
                        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20">
                                  <div className="max-w-3xl">
                                              <span className="text-xs font-black tracking-widest uppercase text-[#FC4C4C] mb-6 block">Our promise</span>span>
