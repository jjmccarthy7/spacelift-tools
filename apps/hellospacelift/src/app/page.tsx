...
// Homepage teaser — first 4 featured + active projects from JSON
          ...
          <div>
                ...
                <section className="bg-[#EEF1F4] py-24 md:py-32">
                        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20">
                          ...
                          <div
                                          ...
                                          >
                                          <div className="mb-3">
                                                            <span className="text-5xl font-black leading-none text-[#3B86E1]">{step}</span>span>
                                          </div>div>
            ...
            {/* Real Results — Projects Teaser */}
                <section className="bg-white py-24 md:py-32">
                        <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20">
                          {/* mb-12 = 48px gap between heading row and card grid */}
