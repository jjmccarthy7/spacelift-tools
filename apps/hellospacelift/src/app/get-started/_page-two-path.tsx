/**
 * ARCHIVED: Two-path get-started page (pre-launch version)
 *
 * This was the original /get-started experience presenting two parallel entry
 * points — the Spacelift app AND a direct Advisor conversation.
 *
 * Preserved here for easy restoration and future A/B testing. To reactivate:
 *   1. Rename this file to page.tsx
 *   2. Rename the current page.tsx to something else (e.g. _page-launch.tsx)
 *
 * Last active: feat/get-started-badges-v2 branch
 */
...
export default function GetStartedPageTwoPath() {
  return (
    <div>
